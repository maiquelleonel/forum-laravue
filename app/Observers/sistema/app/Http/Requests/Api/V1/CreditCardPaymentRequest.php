...
class CreditCardPaymentRequest extends BaseApiRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            // CreditCard Fields
            'payment.CreditCard.number'             => 'required|numeric',
            'payment.CreditCard.cvv'                => 'required|numeric',
            'payment.CreditCard.document_number'    => 'required',
            'payment.CreditCard.name'               => 'required',
            'payment.CreditCard.year'               => 'required|numeric',
            'payment.CreditCard.month'              => 'required|numeric',
            'payment.CreditCard.installments'       => 'required|between:1,12|numeric',
